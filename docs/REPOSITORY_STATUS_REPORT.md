...
- root navigation and mobile-first start pages
- core manuals and module docs
- labs with standardized documentation layout
- incident ticket drills
- sample Suricata EVE telemetry and triage parser/test
- CI/lint workflows and repository validator
